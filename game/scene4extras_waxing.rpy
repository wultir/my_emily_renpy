label day6_waxing_start:
    scene bg black with Dissolve(1.0)

    "Before your brain catches up and makes you say something Emily drags you out "
    "After a short walk and some time later "


    scene bg 0686 with Dissolve(1.0)

    "You both step inside the saloon and a strong looking girl looks at you"

    scene bg 0687 with Dissolve(1.0)

    "?" "Hello. How can I help you both?"

    em "Hello. My name is Emily and I called earlier to book a time here"
    ...
    scene bg 0689 with Dissolve(1.0)

    ja "Have you ever gotten waxed before?"

    em "Once.. Very long time ago"

    mc "No never!"

    ja "Ohh a virgin haha. Don't worry.. It's not painful.. If you are into pain... Haha"


    scene bg 0690 with Dissolve(1.0)
    ...
    ja "I'm a professional and do this for a living so please don't be ashamed. And if you are then we will throw those feelings away soon when my hand is wrapped around your worlds biggest or smallest weewee's haha"
    ...
    mc "Like really really shy.."

    ja "Really.. Don't worry! You'll forget about your weewee when you are screaming in pain and promising to kill me in all kinds of different and painful ways"

    mc "Haha!"
    mc "But do I have to get naked? Like fully naked I mean?"

    ja "Full body trreatment honey. Every cavity will lose its hair today.. Except your head.. So yes!"
    ja "Even your buttplug..."
    ja "Hey! I've seen it all.. Sadly haha"

    em "What if I don't have a weewee?"

    ja "My hands will grab around anything today honey. Even your non existent weewee"
    ...
    em "I have to be careful so other boys don't see that ass!"

    "You are too nervous and try to ignore her. You get your tshirt off but you can't take your jock straps off. You are too ashamed"


    scene bg 0696 with Dissolve(1.0)
    "While going back to your bed Emily grabs your cock and slaps your butt"
    ...
    mc "I wish I would die now. You can't understand how ashamed I am right now!"

    em "This is good training for you. And you are so fucking sexy right now. I'm here, I'll protect my little baby"
    em "Stop worrying!"
    ...
    scene bg 06104 with Dissolve(1.0)
    ...
    ja "Oh... I hope you don't mind that...?"

    em "Mind? I absolutely don't! "
    ...
    em "You are soooo perfect"
    em "That's myyy AHHHHHHHH... clit.."
    em "Sorry for the wetness.."

    ja "No worries honey.. People cum sometimes.. It's only normal so relax"
...
label day6_not_looking:
    ...
    jump day6_skirt_continue


label day6_under_skirt:
    scene bg 06120a with Dissolve(1.0)
    call wait_for_click

    scene bg 06120b with Dissolve(1.0)
    call wait_for_click
...
label day6_skirt_continue:
    ...
    ja "Don't worry. Getting the hot wax on you is a really nice and calming feeling. Only the removal of it causes some pain. Pain and pleasure is the best pleasure there is!"
    ja "Try to think about it that way.. "
    ja "You really have beautiful and smooth legs, you do a great job of trimming your body hairs. So we only need to do your vagina and anus"

    em "Thank you! I only shave my legs and armpits. Luckily I don't get any other body hairs... Yet... Haha"
    ...
    em "Yesss.. It's sooo warm and sticky..."
    em "I'm getting wet again... Sorry.."
    ...
    em "Please... Hurry, I'm, about to cum!"

    ja "Okey are you ready?"

    em "Ahhh. Yes.. Do it baby!!"
    ...
    ja "It's ok honey, you aren't the first to react like this to the intensive sudden pleasure and pain"

    em "Ohh you are so big! I I can feel it!"

    ja "Try to stop moving and shaking about so nothing will happen"

    em "Ahh I ccc ccaan't!"
    ...
    em "But I can feel your huge cock inside me baby"

    ja "Honey... It's soft.. You got a limp sausage inside your hot owen haha"
    ...
    em "That thing must be huge when it's working!"
    em "You could keep fucking me now even when you are soft... And I would cum soon again... Just saying.. Hihi"

    ja "I'm not here to fuck you.. I'm more into.. guys and tight little assholes... "
    ja "But you do have a nice pussy.. And I like you.. But.."
    ja "We are still strangers.. I only fuck strangers if they pay me. But I'm not a whore tonight and I don't want you to know me as a whore.."
    ...
    ja "Haha!"
    ja "Hey you made my skirt all wet!"

    em "I think you made me squirt hihi"
    em "Just take it off... We have all seen everything already"
...
label day6_scared_yes:
    ...
    "You feel strange so you open your eyes"


    jump day6_scared_continue
...
label day6_scared_no:
    ...
    ja "Just relax and close your eyes. I'm going to vax you in almost completely. You don't have much on your upper body but I want to make you 100%% smooth all over"
    ja "You'll love the feeling. Trust me!"
    ja "So close them now blondie"
...
label day6_scared_continue:
    ...
    ja "It's starting to settle"
    ja "I'll count to 5 then you'll lose some hair here. Are you ready?"

    mc "I... I don't think I'm ready"
    ...
    ja "This will hurt a lot more.. Can you hold him still?"

    mc "What the fuck?? Noooo!"
    ...
    scene bg 0307 with Dissolve(1.0)
...
label day6_butt_play_yes:
    ...
    ja "You need a butt plug and lube helps alot!"
    ...
    mc "Ahhh"
    mc "Lube?"
    mc "Why do I feel so full?"

    ja "Hey there"
    ja "You passed out by the pain haha"
    ...
    ja "You really have to get a butt plug"
    ja "And you can train with dildos too"

    em "Yes!"
    em "I already have a dildo but we'll for sure get a plug or 2 haha"

    jump day6_butt_play_done
...
label day6_thank_you_mistress:
    ...
    ja "Thank you blondie!"
    ja "You are sweet!"

    mc "T tthank you"

    jump day6_thanks_done


label day6_thank_you:
...
label day6_thanks_done:
    ...
    ja "It will keep your body smooth and hairless.. So DON'T use it on your head!"
    ja "It also makes your skin much softer. I don't know exactly how it works, but it is legal so no worries"
    ja "I know it has some estrogen agents. So use it maximum once per day"
    ja "Don't overdo it! Or your body hormones could get unbalanced causing all kinds of different trouble. Lethal too.."
    ja "Once per day! Not more!"
    ja "Ok?"

    mc "Lllllethal???"

    em "Thank you Jasmine!"
    em "Can I get your number? We really like you and would love to hang out more with you!"

    ja "AWWWWWWWW of course baby!!!"


    scene bg black with Dissolve(1.0)

    "Emily and Jasmine exchanges numbers and talk for some time before you both leave"

    jump day6_waxing_done
